...
def gcn(input_, output, kernel, stride, relu, bn, name, stddev=0.01):
    with tf.compat.v1.variable_scope(name) as scope:
        ...
        w1_1 = tf.compat.v1.get_variable('w1_1', left_shape_k_1, initializer=tf.compat.v1.truncated_normal_initializer(stddev=stddev))
        w1_2 = tf.compat.v1.get_variable('w1_2', left_shape_1_k, initializer=tf.compat.v1.truncated_normal_initializer(stddev=stddev))
        w2_1 = tf.compat.v1.get_variable('w2_1', right_shape_1_k, initializer=tf.compat.v1.truncated_normal_initializer(stddev=stddev))
        w2_2 = tf.compat.v1.get_variable('w2_2', right_shape_k_1, initializer=tf.compat.v1.truncated_normal_initializer(stddev=stddev))
        b1_1 = tf.compat.v1.get_variable('b1_1', [output], initializer=tf.compat.v1.constant_initializer(0.0))
        b1_2 = tf.compat.v1.get_variable('b1_2', [output], initializer=tf.compat.v1.constant_initializer(0.0))
        b2_1 = tf.compat.v1.get_variable('b2_1', [output], initializer=tf.compat.v1.constant_initializer(0.0))
        b2_2 = tf.compat.v1.get_variable('b2_2', [output], initializer=tf.compat.v1.constant_initializer(0.0))

        conv1_1 = tf.nn.conv2d(input_, filters=w1_1, strides=[1, stride, stride, 1], padding='SAME')
        ...
        conv1_2 = tf.nn.conv2d(conv1_1, filters=w1_2, strides=[1, stride, stride, 1], padding='SAME')
        ...
        conv2_1 = tf.nn.conv2d(input_, filters=w2_1, strides=[1, stride, stride, 1], padding='SAME')
        ...
        conv2_2 = tf.nn.conv2d(conv2_1, filters=w2_2, strides=[1, stride, stride, 1], padding='SAME')
